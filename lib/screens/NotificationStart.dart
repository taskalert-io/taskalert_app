...
// ── Shared color palette + toggle switch ─────────────────────────────────
//
// `ThemeConst`/`ToggleSwitch` used to live only in this file's old
// implementation, but `EmployeesScreen.dart`'s "Task Permission" toggle
// also imports them from here — kept so that usage doesn't break.
