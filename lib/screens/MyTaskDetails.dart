...
class _TaskDetailScreenState extends State<TaskDetailScreen> {
  ...
  /// Reachable by the subtask's assigner (full edit, with the scope
  /// choice) or its own assignee(s) (edit only, always scoped to just
  /// this occurrence) — see `_canEditSubtask`. Delete stays assigner-only.
  void _showEditSubtaskSheet(SubTaskInstanceModel subtask) {
    openEditSubtaskDialog(
      ...
      initialAssigneeIds: subtask.assignees.map((a) => a.id).toList(),
      initialReportingTime: subtask.reportingTime,
